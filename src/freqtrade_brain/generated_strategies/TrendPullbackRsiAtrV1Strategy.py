# Generated by Trading Research OS from YAML spec: trend_pullback_rsi_atr_v1
...
class TrendPullbackRsiAtrV1Strategy(IStrategy):
    """
    Source YAML spec:
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = [(dataframe['close'] > dataframe['ema_200']) & (dataframe['rsi_14'] < 40) & (dataframe['volume'] > dataframe['volume_sma_20'])]
        if conditions:
            dataframe.loc[reduce(lambda left, right: left & right, conditions), "enter_long"] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = [(dataframe['rsi_14'] > 65) | (dataframe['close'] < dataframe['ema_50'])]
        if conditions:
